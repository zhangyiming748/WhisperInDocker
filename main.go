...
func main() {
	...
	for _, file := range files {
		...
		cmd := exec.Command("whisper", file, "--threads", "0", "--model", "base", "--model_dir", "/root/module", "--output_format", "srt", "--prepend_punctuations", ",.?", "--language", language, "--output_dir", root, "--verbose", "True")
